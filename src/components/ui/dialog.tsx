    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          "max-w-[calc(100%-0.5rem)] inset-x-0 mx-auto top-0 translate-y-0 max-h-dvh overflow-hidden",
          "lg:top-[50%] lg:translate-y-[-50%] lg:max-w-lg lg:max-h-none lg:inset-x-auto lg:left-[50%] lg:translate-x-[-50%]",
          className
        )}
        {...props}
      >
